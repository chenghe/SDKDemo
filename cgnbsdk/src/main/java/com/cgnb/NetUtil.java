...
public class NetUtil {
	...
	private static Context ConfigManager = null;
	
	public static void setContext(Context ConfigManager){
		NetUtil.ConfigManager = ConfigManager;
	}
...
//		ToastUtil.showMessage(context, "无法连接网络");
	...
	public static boolean checkSimState() {
		TelephonyManager tm = (TelephonyManager) ConfigManager.getSystemService(Context.TELEPHONY_SERVICE);
